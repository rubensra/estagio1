...
local botaoParametros = { grupo = nil, botaoLivre = nil, botaoPressionado = nil } -- variavel referencia do botao de disparo
...
local function updateFrame()
    ...
    transition.to(fundo, { y = 800, time = 25000, onComplete = function() chefeFinal() end })
end
