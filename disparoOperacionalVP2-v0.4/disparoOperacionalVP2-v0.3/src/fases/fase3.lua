...
local fundo = imagens.carregarFundo(3,backGroup)--cenarios--.um
...
local function ataqueChefe()
    --som.temaChefe();
    transition.to(chefe, { x = math.random(50, 290), y = display.contentCenterY, time = 2000, iterations = 0, transition=easing.continuousLoop } )
...
local function updateFrame()
    ...
    transition.to(fundo, { y =600, time = 15000, onComplete = function() updateFrame2() end })
end
