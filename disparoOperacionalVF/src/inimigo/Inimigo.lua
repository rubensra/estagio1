...
function Inimigo.atingido(parametros)
        ...
        local piscar = function() transition.to(parametros.objchefe, {alpha = 1, time = 300, onComplete = function() return false end }) end
        transition.to(parametros.objchefe, {alpha = 0.3, time = 300, onComplete =  piscar } )
