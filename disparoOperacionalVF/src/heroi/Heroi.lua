...
Heroi = {tipo = nil, imagem = nil, municao = 0 , vidas = nil, died = false, escudo = false, especial = false }
...
function Heroi:setEspecial(valor)
...
function Heroi:DisparoEspecial(grupo)

    disparo.HeroiEspecial(self.imagem,grupo);
end
