...
function transicao.gotoFase1(parametros)
    --local parametros = parametros;
    composer.gotoScene( "src.fases.fase1", { time = 800, effect = "crossFade", params = parametros } )
end

function transicao.gotoFase2(parametros)
    --local parametros = parametros;
    composer.gotoScene( "src.fases.fase2", { time = 800, effect = "crossFade", params = parametros } )
end

function transicao.gotoFase3(parametros)
    --local parametros = parametros;
    composer.gotoScene( "src.fases.fase3", { time = 800, effect = "crossFade", params = parametros } )
end
...
function transicao.posicaoVitoria(botao,nave,parametros)
    ...
    --[[botao.botaoLivre:removeSelf();
    botao.botaoPressionado:removeSelf();
    botao.botaoEspecialLivre:removeSelf();
    botao.botaoEspecialPressionado:removeSelf();
    botao.botaoLivre = nil;
    botao.botaoPressionado = nil;
    botao.botaoEspecialLivre = nil;
    botao.botaoEspecialPressionado = nil;]]
